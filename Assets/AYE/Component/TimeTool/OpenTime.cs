...
public class OpenTime : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PlayerPrefs.GetString("CLOSE_GAME_TIME", "") != "")
        {
            ...
            TimeSpan timeSpan = DateTime.Now.Subtract(AYETool.GetTimeByString(PlayerPrefs.GetString("CLOSE_GAME_TIME")));
    ...
    {
        // 當這個物件被移除時紀錄下線時間
        PlayerPrefs.SetString("CLOSE_GAME_TIME", AYETool.GetStringByDateTime(DateTime.Now));
    }
}
